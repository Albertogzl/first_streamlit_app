...
# tke the json version of the response to normalize it
fruityvice_normalized = pandas.json_normalize(fruityvice_response.json())
# output response as a table
...
my_cur.execute("select * from pc_rivery_db.public.fruit_load_list") # query data
...
#this will not work correctly, but we go eith it for now
